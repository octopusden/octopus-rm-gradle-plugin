...
* The automatic registration is triggered when the property '*-PincludeAllDependencies*' is set. This means that all direct and transitive dependencies of a project will be included automatically.
